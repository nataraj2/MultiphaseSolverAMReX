...
subroutine my_filcc(compno,q,q_l1,q_l2,q_l3,q_h1,q_h2,q_h3,domlo,domhi,dx,xlo,bc)

  use amrex_fort_module, only: rt => amrex_real
  use my_amrex_filcc_module, only: my_filccn
  ...
  call my_filccn(compno, q_lo, q_hi, q, q_lo, q_hi, 1, domlo, domhi, dx, xlo, bc)

end subroutine my_filcc



subroutine my_hoextraptocc(q,q_l1,q_l2,q_l3,q_h1,q_h2,q_h3,domlo,domhi,dx,xlo)
...
end subroutine my_hoextraptocc
