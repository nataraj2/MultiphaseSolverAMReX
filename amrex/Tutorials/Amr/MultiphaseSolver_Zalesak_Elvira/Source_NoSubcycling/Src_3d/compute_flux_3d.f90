   ...
   call new(f_moments)
    ...
    do       k = lo(3), hi(3)
	  ...
	  call construct(flux_hexahedron(1),transported_cell)
          ...
          call compute_fluxes(i,j,k,transported_cell,plocseplink,ploclink,lo,hi,x,y,z,xm,ym,zm,phi,gradxphi_mat,gradyphi_mat,gradzphi_mat,ph_lo,ph_hi,flux,volume)
...
subroutine compute_fluxes(i,j,k,transported_cell,plocseplink,ploclink,lo,hi,x,y,z,xm,ym,zm,phi,gradxphi_mat,gradyphi_mat,gradzphi_mat,ph_lo,ph_hi,flux,volume)
