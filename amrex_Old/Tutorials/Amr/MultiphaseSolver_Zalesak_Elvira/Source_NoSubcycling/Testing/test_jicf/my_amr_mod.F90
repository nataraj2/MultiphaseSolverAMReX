...
contains
  ...
  subroutine my_make_new_level_from_coarse (lev, time, pba, pdm) bind(c)
    ...
    call create_newlevel_and_copy(lev,time,phi_new,phi_old,ba,dm)
    call create_newlevel_and_copy(lev,time,phi_n,phi_n,ba,dm)
    call create_newlevel_and_copy(lev,time,gradxphi,gradxphi,ba,dm)
    call create_newlevel_and_copy(lev,time,gradyphi,gradyphi,ba,dm)
    call create_newlevel_and_copy(lev,time,gradzphi,gradzphi,ba,dm)
  ...
  subroutine my_remake_level (lev, time, pba, pdm) bind(c)
    ...
    call create_remakelevel_and_copy(lev,time,phi_new,phi_old,ba,dm)
    call create_remakelevel_and_copy(lev,time,phi_n,phi_n,ba,dm)
    call create_remakelevel_and_copy(lev,time,gradxphi,gradxphi,ba,dm)
    call create_remakelevel_and_copy(lev,time,gradyphi,gradyphi,ba,dm)
    call create_remakelevel_and_copy(lev,time,gradzphi,gradzphi,ba,dm)
...
subroutine create_remakelevel_and_copy(lev,time,varmfab,varmfab_old,ba,dm)
    ...
    call amrex_multifab_build(varmfab(lev), ba, dm, ncomp, nghost)
    call amrex_multifab_build(varmfab_old(lev), ba, dm, ncomp, nghost)

    do icomp=1,ncomp
       call varmfab(lev)%copy(new_phi_new, icomp, icomp, 1, 0)
    enddo
...
subroutine create_newlevel_and_copy(lev,time,varmfab,varmfab_old,ba,dm)
